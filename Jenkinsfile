        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/cristian2926/Sys-almacen'
                }
            }
        }
        stage('Build') {
